# Data Structures & Algorithms I (数据结构与算法I)
...
Ass：两个大作业，一个与排序有关，一个与队列/栈、链表有关。目的是掌握数据结构的操作，认真亲自完成会增强对数据结构的理解，对刷算法题有帮助。两个大作业都由java编写，非常有趣的一点是，由于Sean的OOP后期学习曲线比较陡峭，这门课的两个编程作业反而是学习Java语法和面向对象编程更好的练习机会，强烈建议自己编写。
